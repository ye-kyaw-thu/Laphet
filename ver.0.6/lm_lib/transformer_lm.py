...
--model ./model/transformer.model --seq_len 50 --epochs 10 --batch_size 32 --lr 0.0001
...
# Training Function
def train_transformer(model, train_dataset, dev_dataset, epochs, batch_size, lr, device, model_save_path):
    """
