...
def main():
    parser = argparse.ArgumentParser(description="Laphet language model toolkit for Burmese.")
    ...
    if args.train:
        ...
        if args.model_type == "mlp":
            ...
            train_mlp(model, train_dataset, dev_dataset, args.epochs, args.batch_size, args.lr, device, args.model)

        elif args.model_type == "bert":
            model = BERT(len(tokenizer.token_to_id), args.embed_dim, args.num_heads, args.num_layers, args.ff_dim, args.seq_len)
            train_bert(model, train_dataset, dev_dataset, args.epochs, args.batch_size, args.lr, device, args.model)
            ...
            train_bilstm(model, train_dataset, dev_dataset, args.epochs, args.batch_size, args.lr, device, args.model)

        elif args.model_type == "gpt":
            model = GPT(len(tokenizer.token_to_id), args.embed_dim, args.num_heads, args.num_layers, args.ff_dim, args.seq_len)
            train_gpt(model, train_dataset, dev_dataset, args.epochs, args.batch_size, args.lr, device, args.model)
            ...
            train_transformer(model, train_dataset, dev_dataset, args.epochs, args.batch_size, args.lr, device, args.model)
